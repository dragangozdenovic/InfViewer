...
public class AddDialogFieldPane extends JPanel {

	private static final long serialVersionUID = 616231892704150505L;
	
	protected List<DialogElement> fieldsInPanel = new ArrayList<DialogElement>();

	public AddDialogFieldPane(Table table) {
	   ...
	   for(Column c : table.getColumns()) {
		   ...
		   if (referencedTable != null)
		   {
			   ...
			   zoomButton.addActionListener(new ActionListener() 
			   {
				   ...
				   {
					   ZoomButtonDialog zoomButtonDialog = new ZoomButtonDialog(AddDialogFieldPane.this, tmp);
					   zoomButtonDialog.setVisible(true);
				   }
			   });
